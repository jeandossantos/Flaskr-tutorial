...
def get_post(id, check_author=True):
    """Get a Post by ID. If check_author=True, it is verified if the post's author is equal to  the user logged in. \n
    if the post is not found, aborts with code 404. \n
    if check_author=True and the post does not belong to this user, aborts with 403."""
